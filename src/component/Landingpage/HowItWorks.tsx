...
const HowItWorks = () => {
    return (
        <div className=" px-minipad lg:px-pad bg-gray-50 py-20">
            <p className="text-primary mb-2 text-center">How it Works</p>
            <h2 className="text-3xl lg:text-4xl font-space font-medium text-dark-green text-center ">Get Started in 3 Easy Steps</h2>


            <div className="grid md:grid-cols-3 gap-10 md:gap-4 lg:gap-10 mt-10">
                <div className="relative ">
                    ...
                    <div className="bg px-10 pt-10 red-500/5 border flex flex-col items-center justify-end  border-green-500/30 backdrop-blur-md rounded-lg mt-8  aspect-square">
